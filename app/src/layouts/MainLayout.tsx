    ...
    <Layout className="min-h-screen">
      ...
      <Sider className="!bg-white border-r border-gray-200 p-5 flex flex-col" width={270}>
        ...
        <div className="space-y-2 mb-6">
          ...
          <NavItem icon={BookOpen} label="Courses" path="/admin/courses"  />
          <NavItem icon={Layers} label="Module" path="/admin/module" />
          <NavItem icon={Users} label="Learners" path="/admin/learners" />
        </div>
